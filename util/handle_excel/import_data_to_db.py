...
sys.path.append(pwd+"../")
os.environ.setdefault("DJANGO_SETTINGS_MODULE","ciliku.settings")
...
class ReadData:
    ...
    def saveToDb(self):
        ...
        for i in range(1, rows_count):  # 循环遍历表数据
            ...
            from mycili.models import videoCiLi
            vcl = videoCiLi()
            vcl.web = excel_0
            vcl.category = excel_1
            vcl.original_title = excel_2
            vcl.actress = excel_3
            vcl.size = excel_4
            vcl.step_riding = excel_5
            vcl.time = excel_6
            vcl.magnetic_force = excel_7
            vcl.preview_one = excel_8
            vcl.preview_two = excel_9
            vcl.preview_three = excel_10
            vcl.save()
